...
//        sendBtn.setOnClickListener(v -> send(sendText.getText().toString()));
        ...
        lineDataSet2 = new LineDataSet(emptyDataValues(), "Y value");
        lineDataSet3 = new LineDataSet(emptyDataValues(), "Z value");
            ...
            if (newline.equals(TextUtil.newline_crlf) && msg.length() > 0) {
                ...
                if (msg_to_save.length() > 1) {
                    ...
                    try {
                        ...
                        data.addEntry(new Entry(counter, Float.parseFloat(parts[1])), 1);
                        data.addEntry(new Entry(counter, Float.parseFloat(parts[2])), 2);
